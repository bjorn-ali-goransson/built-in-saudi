...
// A woman in hijab — filled silhouette (traced from the Saudi "نساء" sign): a hijab
// drape over the head and shoulders framing an open face.
export function HijabiIcon({ className }: P) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" clipRule="evenodd" d="M12 2.6C8.9 2.6 6.6 4.9 6.6 8c0 1.5-.586 4.322-.8 5.5-.534 2.945-1 4.4-1.2 6.9.011.924 14.789.924 14.8 0-.2-2.5-.666-3.955-1.2-6.9-.214-1.178-.8-4-.8-5.5 0-3.1-2.3-5.4-5.4-5.4m0 2.084c-1.9 0-3.2 1.5-3.2 3.3s1.3 3.97 3.2 3.97 3.2-2.17 3.2-3.97-1.3-3.3-3.2-3.3" />
    </svg>
  )
}
...
// out to a less-prominent dashed panel. Rotated so the arrow points UP — a bottom
// (horizontal) dock: prominent panel below, dashed above.

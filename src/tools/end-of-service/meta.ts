...
export const endOfServiceTool: Tool = {
  ...
  keywords: ['end of service', 'resign', 'resignation', 'quit my job', 'what am i owed', 'gratuity', 'mukafaa', 'saudi labor law', 'severance', 'مكافأة نهاية الخدمة', 'نظام العمل', 'استقالة'],
  status: 'beta',
  Icon: BriefcaseIcon,

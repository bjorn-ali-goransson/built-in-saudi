...
const STR = {
  en: { input: 'Options (one per line)', spin: 'Spin', spinning: 'Spinning…', winner: 'Winner', need: 'Add at least two options.', privacy: 'Runs in your browser — nothing is uploaded.' },
  ar: { input: 'الخيارات (خيار في كل سطر)', spin: 'أدِر', spinning: 'يدور…', winner: 'الفائز', need: 'أضف خيارين على الأقل.', privacy: 'يعمل في متصفحك — لا يُرفع أي شيء.' },
}
    ...
    <Stack data-testid="random-picker">
      <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <Button variant="primary" onClick={spin} disabled={n < 2 || spinning} data-testid="rp-spin">{spinning ? s.spinning : s.spin}</Button>

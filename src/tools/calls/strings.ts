...
export const STR = {
  en: {
    ...
    busyRinging: (n: string) => `${n || 'Someone'} is calling`, inACall: 'You’re already in a call', addToCall: 'Add to this call',
  ...
  ar: {
    ...
    busyRinging: (n: string) => `${n || 'شخص'} يتصل بك`, inACall: 'أنت في مكالمة بالفعل', addToCall: 'أضِفه إلى هذه المكالمة',

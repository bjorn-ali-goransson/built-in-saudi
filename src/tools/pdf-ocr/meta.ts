...
export const pdfOcrTool: Tool = {
  ...
  nameAr: 'استخراج نص من PDF ممسوح',
  ...
  category: 'PDF',
  keywords: [
    'ocr', 'scanned pdf', 'scan to text', 'pdf ocr', 'read scan', 'searchable', 'arabic ocr', 'extract text', 'photocopy', 'stamped', 'image pdf',

...
export const ar: Dict = {
  ...
  toolPage: { 
    ...
    moreTools: 'أدوات مجانية أخرى',
    features: 'الميزات الرئيسية',
    howItWorks: 'كيف تعمل الأداة؟',
    faq: 'الأسئلة الشائعة',
    trust: {
      title: 'مجانية، خاصة، وآمنة',
      clientSideTitle: 'تعمل بالكامل في متصفحك',
      clientSideDesc: 'بياناتك لا تغادر جهازك أبداً. نستخدم تقنيات المتصفح لمعالجة كل شيء محلياً.',
      freeTitle: 'مجانية وبلا قيود',
      freeDesc: 'لا اشتراكات، لا قيود على حجم الملفات، ولا حاجة لإنشاء حساب.',
      privacyTitle: 'الخصوصية أولاً',
      privacyDesc: 'لا نستخدم نصوص التتبع أو خوادم الرفع. ما يحدث على جهازك يبقى على جهازك.',
    }
  },
